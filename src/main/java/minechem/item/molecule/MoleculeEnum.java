...
public abstract class MoleculeEnum extends MinechemChemicalType
{
    ...
    public static MoleculeEnum addMoleculeColored(String name, int id, float colorRed, float colorGreen, float colorBlue, float colorRed2, float colorGreen2, float colorBlue2, ChemicalRoomStateEnum roomState, PotionChemical... chemicals)
    {
        MoleculeEnum molecule = new MoleculeEnum(name, id, colorRed, colorGreen, colorBlue, colorRed2, colorGreen2, colorBlue2, roomState, chemicals) {
            @Override
            public MoleculeItem getItem() {
    ...
    public abstract MoleculeItem getItem();
}
