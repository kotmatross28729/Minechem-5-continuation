...
val abracadabra = <minechem:minechemMolecule:181>;
val lectonide = <minechem:minechemMolecule:182>;
...
//Chemicals.addMolecule("abracadabra",181,"Solid",[He*3,ethanol*11,H*5,Au*5]);
//Chemicals.addMolecule("lectonide",182,"Solid",[He*3,ethanol*11,H*5,Au*5]);
...
//Chemicals.addPotionEffect(name of the molecule , effect id , duration of effect, strength of effect);
...
//Chemicals.addCureEffect(lectonide,19);
//Chemicals.addCureEffect(name of the molecule , id of the effect that should be cured);
